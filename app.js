...
var shapes = [];
var maxNumShapes = 7;
var nextShapeId = { "cube" : 1, "tetrahedron" : 1, "cone" : 1, "cylinder" : 1, "sphere" : 1 };
...
function initEventHandlers() {
  ...
  document.getElementById("addTetrahedron").addEventListener("click", addTetrahedron);
...
var Tetrahedron = function(){
	Shape.call(this);
	this.name = "Tetrahedron" + nextShapeId["tetrahedron"]++;
	
	// regular tetrahedron
	this.pushTriangle(vec4(1/2 - 0.5, sqrt(3)/6 - 0.5, sqrt(6)/3 - 0.5, 1), vec4(0 - 0.5, 0 - 0.5, 0 - 0.5, 1), vec4(1 - 0.5, 0 - 0.5, 0 - 0.5, 1));
	this.pushTriangle(vec4(1/2 - 0.5, sqrt(3)/2 - 0.5, 0 - 0.5, 1), vec4(0 - 0.5, 0 - 0.5, 0 - 0.5, 1), vec4(1 - 0.5, 0 - 0.5, 0 - 0.5, 1));
	this.pushTriangle(vec4(1/2 - 0.5, sqrt(3)/6 - 0.5, sqrt(6)/3 - 0.5, 1), vec4(1/2 - 0.5, sqrt(3)/2 - 0.5, 0 - 0.5, 1), vec4(1 - 0.5, 0 - 0.5, 0 - 0.5, 1));
	this.pushTriangle(vec4(1/2 - 0.5, sqrt(3)/6 - 0.5, sqrt(6)/3 - 0.5, 1), vec4(0 - 0.5, 0 - 0.5, 0 - 0.5, 1), vec4(1/2 - 0.5, sqrt(3)/2 - 0.5, 0 - 0.5, 1));

}

Tetrahedron.prototype = Object.create(Shape.prototype);
...
var Cube = function(){
	...
	this.pushSquare(vec4(-1, 1, 1, 1), vec4(-1, 1, -1, 1), vec4(1, 1, -1, 1), vec4(1, 1, 1, 1));
	this.pushSquare(vec4(-1, 1, -1, 1), vec4(-1, -1, -1, 1), vec4(1, -1, -1, 1), vec4(1, 1, -1, 1));
	this.pushSquare(vec4(1, 1, -1, 1), vec4(1, -1, -1, 1), vec4(1, -1, 1, 1), vec4(1, 1, 1, 1));
	this.pushSquare(vec4(-1, 1, 1, 1), vec4(-1, -1, 1, 1), vec4(1, -1, 1, 1), vec4(1, 1, 1, 1));
	this.pushSquare(vec4(-1, 1, -1, 1), vec4(-1, -1, -1, 1), vec4(-1, -1, 1, 1), vec4(-1, 1, 1, 1));
...
function removeAllShapesAndHideRemoveButtons() {
  ...
  nextShapeId = { "cube" : 1, "tetrahedron" : 1, "cone" : 1, "cylinder" : 1, "sphere" : 1 };
  shapes = [];
  resetSliders();
}
